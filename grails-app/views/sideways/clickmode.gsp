...
body {margin:0; padding:0; background:#333 url(assets/sw_page_bg.png); font-family:Helvetica, Arial, sans-serif; font-size:16px;}
/* custom fonts */
@font-face {
...
#outer_container{position:relative; margin:0; width:700px; padding:0; z-index:2; background:url(assets/empty.gif);} /* fucking IE needs a background value to understand hover area */
#customScrollBox{position:relative; background:url(assets/sw_l_bg.png) repeat-y;}
...
#arrow_indicator{position:absolute; cursor:pointer; width:50px; padding:10px; top:50%; margin-top:-25px; left:20px; background:url(assets/sw_transparent_black_bg.png); -moz-border-radius:5px; -khtml-border-radius:5px; -webkit-border-radius:5px; border-radius:5px; display:none;}
...
<div id="customScrollBox">
	<div class="container">
    	<div class="content">
            ...
            <p>A simple, yet elegant fullscreen image gallery created with the jQuery framework and some simple CSS. Full post and download files.</a></p>
...
<div id="bg">
    ...
    <div id="arrow_indicator" title="Open images thumbnails"><img src="assets/sw_arrow_indicator.png" width="50" height="50" alt="Open images thumbnails" /></div>
